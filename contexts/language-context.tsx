...
const translations = {
  en: {
    ...
    "projects.project1.title": "Web App for Record Label",
    "projects.project1.description": "Web platform for a record label that allows users to explore and listen to music.",
    "projects.project2.title": "MAF Car Dealership",
    "projects.project2.description": "Online vehicle catalog with advanced filters and external API integration.",
    "projects.project3.title": "Institutional Website - Event Producer",
    "projects.project3.description": "Corporate website with elegant design and SEO optimization.",
    "projects.project4.title": "Landing Page for Psychologist",
    "projects.project4.description": "Website for psychologist specialized in children and adolescents with modern, minimalist and responsive design.",
    "projects.project5.title": "Government Web App Optimization",
    "projects.project5.description": "UX/UI improvements, implementation of reusable components and SEO optimization on the Municipality of La Granja website.",
