...
const translations = {
  en: {
    ...
    "hero.description": "Fullstack Developer specialized in Next.js, TypeScript, MongoDB and Express.js",
    ...
    "about.description": "Fullstack Developer with 2 years of hands-on experience in real projects, specialized in Next.js, TypeScript and the MERN stack. Currently developing modern and optimized interfaces.",
    "about.feature1.title": "Fullstack Development",
    "about.feature1.description": "2 years of experience creating modern interfaces with React, Next.js, MongoDB, Node.js and TypeScript",
  ...
  es: {
    ...
    "hero.description": "Fullstack Developer especializado en Next.js, TypeScript, MongoDB y Express.js",
    ...
    "about.description": "Desarrollador Fullstack con 2 años de experiencia práctica en proyectos reales, especializado en Next.js, TypeScript y el stack MERN. Actualmente desarrollando interfaces modernas y optimizadas.",
    "about.feature1.title": "Desarrollo Fullstack",
    "about.feature1.description": "2 años de experiencia creando interfaces modernas con React, Next.js, MongoDB, Node.js y TypeScript",
